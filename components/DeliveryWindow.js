                    ...
                    <div className="order__conditions--container">
                       <div className="conditions__header__container">
                        ...
                        <ul className="conditions__list">
                            ...
                            <li className="conditions--item"> <div className="red__round double__string__position"> </div> <span className="conditions--text">При заказе с сайта, шампур картошки <br></br> в подарок.</span></li>
                        </ul>
